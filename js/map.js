// Initialize Leaflet map in footer map container
// Approximate coordinates for Colombo 7 (Horton Place area)
(function () {
  try {
    ...
    L.marker([6.9066, 79.8667]).addTo(map).bindPopup('Amaran Medical & Aesthetic Centre').openPopup();
  } catch (e) {
